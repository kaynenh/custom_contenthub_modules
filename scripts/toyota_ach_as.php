...
foreach ($chunks as $operation_key => $chunk) {
  $operations[$operation_key] = [
    'toyota_acquia_contenthub_subscriber_audit_subscriber',
...
foreach ($contenthub_filters as $contenthub_filter) {
  ...
  for ($i = 0; $i < $iterations; $i++) {
    ...
    $start = $i * 1000;
    $operations[$operation_key] = [
      'toyota_acquia_contenthub_subscriber_audit_subscriber_find_missing_imports',
...
$batch = [
  ...
  'finished' => 'toyota_acquia_contenthub_subscriber_audit_subscriber_finished',
];

$batch['file'] = '../../../../../home/toyotabrasildds/toyota_ach_as_batch_functions.php';
